...
START_DATE="2022-05-7"  # YYYY-MM-DD
END_DATE="2022-10-24"    # YYYY-MM-DD
...
AUTHOR_NAME="nightmare"
AUTHOR_EMAIL="nightmare5831@gmail.com"
...
commit_messages=(
    ...
    "fix tests"
    "enable feature behavior"
    "add interface or factory"
    "improve navigation behavior"
    "performance improvements"
    "chore: update configuration or license"
    "initial commit"
